...
public class JTabbedPaneTest {
    ...
    public void init() {
        ...
        //添加标签
        tabbedPane.addTab("用户管理",
                new ImageIcon(JTabbedPaneTest.class.getClassLoader().getResource("img/open.gif")),
                new JList<String>(new String[]{"用户一", "用户二", "用户三"}));
        tabbedPane.addTab("商品管理",
                new JList<String>(new String[]{"商品一", "商品二", "商品三"}));
        tabbedPane.addTab("订单管理",
                new ImageIcon(JTabbedPaneTest.class.getClassLoader().getResource("img/open.gif")),
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                System.err.println("当前选中了第 " + (selectedIndex + 1) + "个标签");
            }
        });
